...
class HumiditySensor:
    def __init__(self, sensor_id, broker_address, topic, file_path):
        ...
        self.ssdp_message = f"SSDP_ANNOUNCE_HUMIDITY:{self.sensor_id}"
    ...
    def read_humidity(self):
        try:
            ...
            print(f"Greska pri citanju vlage: {e}")
            return None
...
if __name__ == "__main__":
    ...
    TOPIC = "senzori/beton/vlaga/nivo"
    FILE_PATH = "../humidity.txt"
    sensor = HumiditySensor(sensor_id="humidity_1", broker_address=BROKER, topic=TOPIC, file_path=FILE_PATH)
